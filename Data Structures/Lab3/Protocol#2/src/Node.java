 ...
 * <p>
 * This version has different priority scheme which solves ties alphabetically
 * first, and then by the length of groups.
 * 
 * @version 1.1
...
public class Node implements Comparable<Node> {
	...
	public int compareTo(Node node) {
		if (freq < node.getFreq())
			...
			else if (data.charAt(0) == node.getData().charAt(0)) {
